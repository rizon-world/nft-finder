...
<header class="sticky top-0 bg-white">
    ...
    <div class="text-center p-4 mx-0 md:hidden">
      <form class={`w-full mx-auto justify-between p-2 my-2 flex-shrink rounded-md  border-solid border-2 border-gray-600 flex ${focused ? "focus-on" : ""}`} on:submit={(e) => e.preventDefault()} >
