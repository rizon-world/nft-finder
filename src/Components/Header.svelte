...
<header class="sticky top-0 bg-white">
    <div class="text-center p-4 mx-0 flex justify-between">
      ...
      <form action="/contract/" class={`w-1/2 mx-auto justify-between p-2 my-2 flex-shrink rounded-md  border-solid border-2 border-gray-600 md:flex hidden ${focused ? "focus-on" : ""}`} on:submit={handleSearch} >
