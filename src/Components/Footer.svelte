<script lang="ts">
import Logo from '../assets/Logo_vertical_dark.svelte';
...
<footer
  ...
  <div
    ...
    <a href="https://twitter.com/hdac_rizon" target="_blank"
      ><svg
    ...
    <a
      href="https://www.youtube.com/channel/UCGQXVXTs7RllAirD3YjjZIQ"
      target="_blank"
      ><svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
        ...
        ></svg
      ></a>
    <a href="https://www.facebook.com/hdacrizon" target="_blank"
      ><svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
        height="24"
